...
export async function resolveAndFreezeTreatment({
  ...
  if (!runDir) {
    throw new Error('resolveAndFreezeTreatment: runDir required');
  }
  if (!name) {
    throw new Error('resolveAndFreezeTreatment: name required');
  }
  if (!liveDir) {
    throw new Error('resolveAndFreezeTreatment: liveDir required');
  }
...
export async function assertMarkTreatmentFrozen({
  ...
  if (!runDir) {
    throw new Error('assertMarkTreatmentFrozen: runDir required');
  }
  const errors = [];
