export const CORE_COMMANDS = Object.freeze([
  ...
  {
    path: ['pack-analysis'],
    usage: 'pack-analysis <exp> --to <path.zip> [--depth audit] [--dry-run]',
    ...
    examples: ['forge pack-analysis prompt-routing --to ./prompt-routing-audit.zip'],
  },
  {
    path: ['verify-analysis'],
    usage: 'verify-analysis <path.zip>',
    ...
    examples: ['forge verify-analysis ./prompt-routing-audit.zip'],
  },
  {
    path: ['runs'],
    usage: 'runs <exp>',
