export const CORE_COMMANDS = Object.freeze([
  ...
  },
  {
    ...
    summary: 'Two-phase judging convenience. Default phase prepares judge prompts and prints the gpt-5.5 dispatch contract; --finalize validates verdicts, collects them, and scores.',
    effect: 'mutate-local',
    input: {
      positionals: [{ name: 'exp', required: true }],
      flags: [
